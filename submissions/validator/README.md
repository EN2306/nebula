# PS1 validator uploads

Upload A.zip, B.zip or C.zip to its matching scenario. Each ZIP contains exactly
the three required CSV files at the archive root. Do not add this README or any
validation JSON to an archive.
...
Regenerate with `npm run results` then `node scripts/package-submissions.mjs`.
